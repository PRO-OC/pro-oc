...
if(TestovanyJmenoElement) {
    TestovanyJmenoElement.addEventListener('input', loadAndSetOckoUzisPatientCredentials);
}
if(TestovanyPrijmeniElement) {
    TestovanyPrijmeniElement.addEventListener('input', loadAndSetOckoUzisPatientCredentials);
}
if(TestovanyCisloPojistenceElement) {
    TestovanyCisloPojistenceElement.addEventListener('input', loadAndSetOckoUzisPatientCredentials);
}
if(TestovanyNarodnostElement) {
    TestovanyNarodnostElement.addEventListener('input', loadAndSetOckoUzisPatientCredentials);
}
if(TestovanyDatumNarozeniElement) {
    TestovanyDatumNarozeniElement.addEventListener('input', loadAndSetOckoUzisPatientCredentials);
}
...
function loadAndSetOckoUzisPatientCredentials() {
    if(
        ...
        chrome.runtime.sendMessage({
            "text": "OckoUzisPatientCredentials",
            "data": {
                "Jmeno": TestovanyJmenoElement.value,
                "Prijmeni": TestovanyPrijmeniElement.value,
                "DatumNarozeni": TestovanyDatumNarozeniElement.value,
                "StatniPrislusnost": TestovanyNarodnostElement.value,
                "CisloPojistence": TestovanyCisloPojistenceElement.value
            }
        }, function(PatientCredentials) {
            if(PatientCredentials.Telefon && PatientCredentials.Email) {
                setOckoUzisPatientCredentials(PatientCredentials.Telefon, PatientCredentials.Email);
                setOckoUzisPatientDetailEditLink(PatientCredentials.EditLink);
            }
        });
    } else {
